...
aggression (either aggressive or defensive will add switch abilities and low health implications) (add to enemy class)
...
aggression algorithm(actions left, gameboard, enemy, pathfinder, enemy)

items to add to enemy class: preferred_tactic, tactics, aggression, 
